...
import { Rule, SchematicContext, Tree, externalSchematic, chain, apply, url, move, template, strings, mergeWith } from '@angular-devkit/schematics';
import * as ts from '@schematics/angular/third_party/github.com/Microsoft/TypeScript/lib/typescript';
import { findNodes, insertImport } from '@schematics/angular/utility/ast-utils';
import { InsertChange } from '@schematics/angular/utility/change';

interface ConfigurableModuleSchemaOptions {
  name: string;
}

function updateModuleFile(
  tree: Tree,
  options: ConfigurableModuleSchemaOptions
): Tree {
...
// per file.
export function generate(options: ConfigurableModuleSchemaOptions): Rule {
